...
Para acceder a la API ANI (Registraduría), debes autenticarte con un token de acceso. El endpoint de autenticación valida las credenciales del cliente y retorna un token JWT que debes incluir en todas las solicitudes posteriores.
...
- [Realizar consulta ANI →](endpoints/verification.md)
